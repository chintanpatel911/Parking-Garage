...
// Did the user a correct password/email and click submit?
	if ($_POST && !empty($_POST['email']) && !empty($_POST['pwd'])) {
		$validation = validate_user($_POST['email'], $_POST['pwd']);
	}
?>
	...
	<nav>
		<ul class="sf-menu">
			...
			<li class="current"><a href="account.php">Account</a>
				...
				<li class="account"><a href="account.php">Log-In</a></li>
...
<?php
	if (isset($validation)) {
		//echo "<h4 class='alert'>" . $validation . "</h4>";
...
?>
									...
									<div class="aligncenter">
										...
										<a href="register.php" class="link">Register account</a>
									</div>
								</dd>
							 </dl>
						</center>
